...
let night = false;
let isImageLoaded = false;  // 이미지가 로드되었는지 여부를 저장할 변수
...
const TwoDCanvas = () => {
  ...
  useEffect(() => {
    ...
    // let spriteX = false ? this.night_spriteX : this.day_spriteX;
  ...
  //         if (this.speed >= this.jump / 5) {
  //           // console.log()
  //           // this.rotation = 90 * DEGREE;
  //           // console.log("speed : ", this.speed)
  //           // this.rotation = Math.min((this.speed / 10) * 90, 0);
  //           // this.rotation = 90  * DEGREE;
  //           // console.log((this.speed / 10) * 90)
  //           this.rotation = Math.min((this.speed / 10) * 50, 90) * DEGREE;
  ...
  //     // pipes.h = cvs.height * 0.688;
  //     pipes.gap = cvs.height * 0.227;
